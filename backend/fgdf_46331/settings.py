"""
Django settings for fgdf_46331 project.
...
WSGI_APPLICATION = 'fgdf_46331.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fgdf_46331 API",
    "DESCRIPTION": "API documentation for fgdf_46331 App",
    "VERSION": "v1",
}
